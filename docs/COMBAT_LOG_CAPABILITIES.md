...
| Capability                             | Desired outcome                                           | Expected event / evidence source                                                        | Status               | Confidence | Known limitations                                                      | Required fixture / scenario                                                                                                                                                                                                                                                                                                                                          | Fallback behavior                                                       |
| -------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------------------------------------- | -------------------- | ---------- | ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| Combat-log file rotation or truncation | Resume without duplicate or skipped events                | File size shrink, new `WoWCombatLog-*.txt`, byte offset + file identity                 | Tested synthetically | —          | Unverified assumption: retail may rotate on a new logging session      | `internal/logwatcher/watcher_test.go`, `cmd/yeetcraft-companion/main_test.go`                                                                                                                                                                                                                                                                                                                                         | Unique client event IDs + offset persistence; generation reset on truncate/replace |
...
| 3   | Which signals distinguish an abandoned run from a paused or interrupted run?                                          | Phase 2 session state (timeout/exit → `abandoned`; real-log signals remain backlog) |
...
| 5   | How should run identity continue across reload/restart/file rotation?                                                   | Phase 2 implemented: persisted offset + `clientRunId` excludes file identity; restart restores active run from SQLite |
